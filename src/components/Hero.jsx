            ...
            >
                <div className="hero-text">
                    <motion.h1 className="hero-title" variants={itemVariants}>
                        Hi, I'm <span className="apple-gradient-text">Rakshit Raj</span>
                    </motion.h1>
                    ...
                    <motion.div className="hero-action-group" variants={itemVariants}>
                        ...
                        <div className="hero-socials">
                            <a href="https://github.com/TheRakshitRaj" className="social-link" aria-label="GitHub">
                            ...
                            <a href="https://www.linkedin.com/in/rakshit-raj-34a47739a/" className="social-link" aria-label="LinkedIn">
                ...
                <motion.div
                    ...
                    animate="float" // Constantly floating
                >
                    <img
